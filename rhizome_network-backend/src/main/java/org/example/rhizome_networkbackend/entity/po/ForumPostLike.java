...
public class ForumPostLike implements Serializable {
	...
	public String toString (){
		return "id:"+(id == null ? "空" : id)+"，postId:"+(postId == null ? "空" : postId)+"，userId:"+(userId == null ? "空" : userId)+"，createTime:"+(createTime == null ? "空" : DateUtil.format(createTime, DateTimePatternEnum.YYYY_MM_DD_HH_MM_SS.getPattern()));
	}
}
